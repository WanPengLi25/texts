...
<div class="right" id="li07">
	<div class="right01">
		<img src="/MI-4-20/Public/Sun/img/04.gif" /> 权限管理 &gt; <span>编辑权限</span>
	</div>
	<div class="rightmain">
			...
			<form class="Aut_addform" method="post">
				<input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
			  	<div class="form-group">
			    	...
			    	<input type="text" class="form-control" id="name" placeholder="模块/控制器/方法名" name="name" value="<?php echo ($list["name"]); ?>">
			  	</div>
			  	<div class="form-group">
			    	<label for="title"><h4>权限名</h4></label>
			    	<input type="text" class="form-control" id="title" placeholder="权限名" name="title" value="<?php echo ($list["title"]); ?>">
			  	</div>
			  	<div class="form-group">
				  	<h4>状态</h4>
				  	<select style="margin-top:10px" class="form-control" name="status">
					  	<option value="1">启用</option>
				  	<?php if($list['status'] == 0 ): ?><option selected value="0">禁用</option>
					<?php else: ?>
