...
<div class="right" id="li07">
	<div class="right01">
		<img src="/MI-4-20/Public/Sun/img/04.gif" /> 用户管理 &gt; 查看用户 &gt; <span>编辑用户</span>
	</div>
	<div class="rightmain">
		...
		<link rel="stylesheet" type="text/css" href="/MI-4-20/Public/Sun/css/chenxustyle.css">
			<center>
				...
				<?php if(is_array($userinfo)): foreach($userinfo as $key=>$vo): ?><form class="form-horizontal" method="post" action="<?php echo U('User/editUserPassword?uid='.$vo['uid']);?>">
				<!--URL里面的{}里如果有传参，并且参数不是确定的，那就要用[]-->
					<div class="form-group Use_edit">
					    <label for="input" class="col-sm-2 control-label">用户ID</label>
					    <div class="col-sm-10">
					      	<input class="form-control" id="disabledInput" type="text" value="<?php echo ($vo["uid"]); ?>" name="id" disabled>
					    </div>
					</div>
					<div class="form-group Use_edit">
					    <label for="input" class="col-sm-2 control-label">用户名</label>
					    <div class="col-sm-10">
					      	<input type="text" class="form-control" id="inputEmail3" value="<?php echo ($vo["name"]); ?>" disabled>
					    </div>
					</div>
					<div class="form-group Use_edit">
					    <label for="input" class="col-sm-2 control-label">密码</label>
					    <div class="col-sm-10">
					      	<input type="password" class="form-control" id="inputEmail3" value="<?php echo ($vo["pass"]); ?>" name="pass">
					    </div>
					</div>  					  
					<div class="form-group Use_editbutton">
