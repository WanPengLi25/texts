...
<div class="rrcc" id="RightBox">﻿<div class="right" id="li07">
	...
	<div class="rightmain">
		<div class="ind_main center-block">
			...
			<form class="form-inline" action="<?php echo U('TypeGroup/selectTypeGroup');?>" method="get">
			...
			<table class="table table-hover">
				...
				<?php if(is_array($TypeGroup)): foreach($TypeGroup as $key=>$v): ?><tr>
						<td><?php echo ($v["id"]); ?></td>
						<td><?php echo ($v["groupname"]); ?></td>
						<td><?php echo ($v["tids"]); ?></td>
						<td>
						...
						<td>
							<?php if($v["vs"] == 0): ?><a class="vs text-danger" href="javascript:;"data-id="<?php echo ($v["id"]); ?>"data-vs="<?php echo ($v["vs"]); ?>">1</a>
							<?php elseif($v["vs"] == 1): ?>
								<a class="vs text-success" href="javascript:;"data-id="<?php echo ($v["id"]); ?>"data-vs="<?php echo ($v["vs"]); ?>">2</a>
							<?php else: ?>
								<a class="vs text-success" href="javascript:;"data-id="<?php echo ($v["id"]); ?>"data-vs="<?php echo ($v["vs"]); ?>">3</a><?php endif; ?>
						</td>
						<td>
							<!-- <a href="<?php echo U('TypeGroup/saveTypeGroup','id='.$v['id'] );?>">编辑</a> -->
							<a href="<?php echo U('TypeGroup/saveTypeGroup?id='.$v['id'].'&tids='.$v['tids'] );?>">编辑</a>
							<a  class="delete" href="javascript:;"  data-id="<?php echo ($v["id"]); ?>">删除</a>
						</td>
...
<script>
	...
	$('.delete').click( function() {
		var that = $(this);
		$.get(
			'<?php echo U("TypeGroup/ajaxDeleteType");?>',
	...
	$('.status').click( function() {
		var that = $(this);
		$.get(
			'<?php echo U("TypeGroup/ajaxStatusType");?>',
			{
				id:that.attr('data-id'),
	...
	// 	var that = $(this);
	// 	$.get(
	// 		'<?php echo U("TypeGroup/ajaxVsType");?>',
	// 		{
	// 			id:that.attr('data-id'),
