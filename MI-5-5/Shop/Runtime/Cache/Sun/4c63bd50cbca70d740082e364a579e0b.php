...
<div class="right" id="li07">
	<div class="right01">
		<img src="/MI-4-20/Public/Sun/img/04.gif" /> 站点管理 &gt; 轮播图 &gt;  <span>添加轮播图</span>
	</div>
	<div class="rightmain">
	<!-- 加载css样式 -->
	...
	<!-- 加载js样式 -->
		...
		<!--表单开始-->
		<form class="form-inline myform" method="post" enctype="multipart/form-data" action="<?php echo U('Shuffing/addShuffing');?>">
		...
		<script>
	        ...
	        $(".dropzone").dropzone({
	        	...
	        	//请求一个PHP来做上传
		        url: "/MI-4-20/index.php/Sun/Shuffing/upload/",
