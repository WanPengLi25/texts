...
<div class="right" id="li07">
	<div class="right01">
		<img src="/MI-4-20/Public/Sun/img/04.gif" /> 权限管理 &gt; <span>查看权限</span>
	</div>
	<div class="rightmain">
			...
			<div class="Aut_showform">
				<form class="form-inline" method="get">
				  	<div class="form-group">
						...
						<?php if($status == 0): ?><option selected value="0">权限名</option>
						<?php else: ?>
							<option value="0">权限名</option><?php endif; ?>
						</select>
				  	</div>
				  	<div class="form-group">
		...
		<?php if($list != 0): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
				...
				<?php else: ?>
					...
					<td>
						<a class="btn btn-primary btn-sm btn-info" href="<?php echo U('Auth/updataAuth', 'id='.$vo['id']);?>">编辑</a>
