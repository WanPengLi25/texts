    ...
    <header>
        <div class="header-nav">
            ...
            <div class="header-right right">
                ...
                <div class="H-right-gwc-scan">
                        ...
                        <li>
                                <div class="H-right-gwc-scan-goods">
                                    <div><img src="/MI-4-20/Public/imgs/9/9-0.jpg" width="60" height="60"></div>
                                    <div style="width:80px;line-height:40px"><a href="/MI-4-20/index.php/Home/Detail/detail/gid/9.html">米兔</a></div>
                ...
                <div class="user">
                        <a style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:block;width:80px;float:left;padding-left:5px" class="a" href="/MI-4-20/index.php/Home/Personal/personal.html">8858f879c9e8691                        </a> 
                        <span style="float:right;line-height:40px" class="fa fa-angle-down"></span>  
                        <div class="userul">
                            <ul>
