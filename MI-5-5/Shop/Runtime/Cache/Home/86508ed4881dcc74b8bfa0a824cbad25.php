        ...
        <div class="header-nav">
            ...
            <div class="header-right right">
                <div class="H-right-main">
                    <a style='background:darkorange;color:white' href="shopcart.php" class="H-right-gwc right">
                ...
                <div class="H-right-gwc-scan">
                        ...
                        <li>
                                <div class="H-right-gwc-scan-goods">
                                    <div><img src="/MI-4-20/Public/imgs/7/7-0.jpg" width="60" height="60"></div>
                                    <div style="width:80px;line-height:40px"><a href="/MI-4-20/index.php/Home/Goods/goodsDetails/id/7.html">小米平板2</a></div>
